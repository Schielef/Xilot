...
module.exports = {
    ...new SlashCommandBuilder()
        .setName("activity-sketchheads")
        .setDescription("Start a Sketchheads session"),
    ...
    run: async (client, interaction, args) => {
        ...
        if (channel.type !== "GUILD_VOICE") {
            ...
            client.discordTogether.createTogetherCode(channelid, 'sketchheads').then(async invite => {
